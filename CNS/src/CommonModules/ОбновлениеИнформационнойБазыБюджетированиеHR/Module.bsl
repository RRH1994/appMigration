...
Процедура ПриДобавленииПодсистемы(Описание) Экспорт
	...
	//KSA 18.07.2022 - РахметовРХ -
	Описание.Имя    = "БюджетированиеHR";
	Описание.Версия = "1.0.1.1";
	
	//Требуются библиотека стандартных подсистем
...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	ЭтоНачальноеЗаполнениеИлиОбновление = БюджетированиеРасширенныйПовтИсп.ЭтоНачальноеЗаполнениеИлиОбновление();
	
	Если ЭтоНачальноеЗаполнениеИлиОбновление Тогда
		
		Обработчик = Обработчики.Добавить();
		Обработчик.Процедура = "ОбновлениеИнформационнойБазыБюджетированиеHR.УстановитьИспользованиеНесколькихОрганизаций";
